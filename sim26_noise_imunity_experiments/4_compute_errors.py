...
experiment_tensor = tensor_load.TensorLoad("networks/" + "noise_0_0/" + "net_0_single/trajectory_result/trajectory.json", load_start_offset, load_reshaped)
libs_compute_errors_euklidian_distance.save_errors(target_tensor.get(), experiment_tensor.get(), "./errors/noise_0_0/net_0_single/")
